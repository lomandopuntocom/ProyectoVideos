...
@Component({
  selector: 'administrarvideos',
  templateUrl: './administrarVideos.component.html',
  styleUrls: ['./administrarVideos.component.css']
})

export class AdministrarVideosComponent {
